...
import * as _checkControllerPresentAndSetup from './tracked-controls.js';
var checkControllerPresentAndSetup = _checkControllerPresentAndSetup;
console.log(checkControllerPresentAndSetup);
 ...
 */
AFRAME.registerComponent('custom-hand-tracking', {
  schema: {
  ...
  updateReferenceSpace: function () {
    ...
    xrSession.requestReferenceSpace(referenceSpaceType).then(function (referenceSpace) {
      ...
      self.el.sceneEl.systems.webxr.warnIfFeatureNotRequested(referenceSpaceType, 'controls-webxr uses reference space ' + referenceSpaceType);
      throw error;
    });
  },
  ...
  tick: function () {
    var sceneEl = this.el.sceneEl;
    var controller = this.el.components['custom-tracked-controls'] && this.el.components['custom-tracked-controls'].controller;
  ...
  updateHandDotsModel: function () {
    var frame = this.el.sceneEl.frame;
    var controller = this.el.components['custom-tracked-controls'] && this.el.components['custom-tracked-controls'].controller;
    var trackedControlsWebXR = this.el.components['custom-tracked-controls-webxr'];
  ...
  injectTrackedControls: function () {
    var el = this.el;
    var data = this.data;
    el.setAttribute('custom-tracked-controls', {
      hand: data.hand,
  ...
  onControllersUpdate: function () {
    var controller;
    this.checkIfControllerPresent();
    controller = this.el.components['custom-tracked-controls'] && this.el.components['custom-tracked-controls'].controller;
