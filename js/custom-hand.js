...
var MODEL_URLS = {
  toonLeft: '../../glbs/hands/leftHand.glb',
  toonRight: '../../glbs/hands/rightHand.glb',
  lowPolyLeft: '../../glbs/hands/leftHandLow.glb',
  lowPolyRight: '../../glbs/hands/rightHandLow.glb'
};
...
AFRAME.registerComponent('hand-custom', {
  schema: {
    ...
    hand: { default: 'left' },
    handModelStyle: {default: 'toon', oneOf: ['lowPoly', 'highPoly', 'toon']}
  },
  ...
  update: function (previousHand) {
    ...
    if (hand !== previousHand) {
      ...
      this.loader.load(handmodelUrl, function (gltf) {
        ...
        var bugHandOrientation = hand === 'left' ? -Math.PI : 0;
        ...
        mesh.rotation.set(0, bugHandOrientation, handModelOrientation);
